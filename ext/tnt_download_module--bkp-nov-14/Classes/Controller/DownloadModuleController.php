...
class DownloadModuleController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
    ...
    public function listAction() {
        $base_url = $GLOBALS['TSFE']->baseUrl . "typo3conf/ext/tnt_download_module/Resources/Public/";
        ...
        if ($flexSettings['view_type'] == 'widget') {
            $GLOBALS['TSFE']->getPageRenderer()->addJsFooterFile($base_url . 'Js/mainWidet.js', NULL, FALSE, FALSE, '', TRUE);
            ...
            $GLOBALS['TSFE']->getPageRenderer()->addJsFooterFile($base_url . 'Js/main.js', NULL, FALSE, FALSE, '', TRUE);
        }
