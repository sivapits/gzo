...
/**
 * Test case for class Tx_Tnt_download_module_Controller_DownloadModuleController.
 *
 * @version $Id$
 ...
 */
class DownloadModuleControllerTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var 
	 */
	protected $fixture;
