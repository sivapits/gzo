 ...
 * @subpackage	solr
 */
class tx_solr_pi_results_LastSearchesCommand implements tx_solr_PluginCommand {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/solr/pi_results/class.tx_solr_pi_results_lastsearchescommand.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/solr/pi_results/class.tx_solr_pi_results_lastsearchescommand.php']);
}
