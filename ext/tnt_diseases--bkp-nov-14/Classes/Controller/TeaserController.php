...
class TeaserController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
    ...
    public function __construct() {
        ...
        $base_url = $GLOBALS['TSFE']->baseUrl . "typo3conf/ext/tnt_diseases/Resources/Public/";
        $GLOBALS['TSFE']->getPageRenderer()->addJsFooterFile($base_url . 'Js/CustomMain.js', NULL, FALSE, FALSE, '', TRUE);
    }
    /**
     * action gridList
     *
