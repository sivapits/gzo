...
//       var files = ['fileadmin/themes/templates/css/bootstrap.css', '/fileadmin/themes/templates/css/bootstrap.min.css', 'fileadmin/themes/templates/css/default.css', 'fileadmin/themes/templates/css/font-awesome.css', 'fileadmin/themes/templates/css/bootstrap-select.css', 'fileadmin/themes/templates/css/jquery.jscrollpane.css', 'fileadmin/themes/templates/css/lightbox.css', 'fileadmin/themes/templates/css/override.css'];
...
$(document).ready(function() {
    $(".mod-details h2").click(function () {
        $header = $(this);
        //alert($header);
        $content = $(this).parent().siblings(".collapse");
        $content1 = $(this).siblings(".collapse");
        //console.log($content1);
        if ($(this).siblings('.collapse').length){
        // $content1.slideToggle('0',"linear", function () {
        // });
         //$content1.toggleClass('mod-block');
        // if ( $content1.height === '0px') {
        //     $content1.removeClass('mod-block');
        // }         

        }
        else
        {
        // $content.slideToggle('0',"linear", function () {
        // });
         // $content.toggleClass('mod-block');
    ...
    $('nav.navbar-default .navbar-nav > li.dropdown').on('hover touchstart', function(e) {
       // alert('test');
        var children = $(this).children('a');
        var findwidth = children.outerWidth();
        //alert(findwidth);
        var listedChildren = $(this).children('ul');
        if (findwidth>200)
        {
            listedChildren.css('min-width',findwidth);
        }
    });
...
window.addEventListener(orientationEvent, function() {
  //  alert('ROTATING SCREENS:' + window.orientation + " " + screen.width);
}, false);