...
humanBuilder = {
    ...
    process: function(obj) {
        ...
        $('.humanbuilder .part').on('click', function() {
    ...
    toolTip: function() {
        ...
        $('.humanbuilder .part').on('mousemove click',function(e){
            console.log(e);
            //$('.builder-tooltip').css({'left':e.pageX+20,'top':e.pageY});
            $('.builder-tooltip').css("top",(e.pageY - xOffset) + "px")
            $('.builder-tooltip').css("left",(e.pageX - $(.builder-tooltip).width() - options.xOffset - 20) + "px")
